...
class App(ctk.CTk):
    ...
    def draw_main_interface(self):
        ...
        lbl_footer = ctk.CTkLabel(sidebar, text="v1.0.0 Stable  |  Windows System Tool", font=FONT_CAPTION, text_color="#5E5E6F")
        lbl_footer.pack(side="bottom", pady=(0, 6))
        ...
        btn_github.pack(side="bottom", fill="x", padx=12, pady=(0, 4))
